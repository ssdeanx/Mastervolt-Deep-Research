  ...
  execute: (args, context) => {
    ...
    try {
      ...
      return {
        jsonData,
        structure,
        rootKeys: typeof jsonData === 'object' && jsonData !== null ? Object.keys(jsonData as Record<string, unknown>) : [],
...
export const svgToJsonTool = createTool({
  ...
  execute: (args, context) => {
    ...
    try {
      ...
      const parsedSvg = parser.parse(args.svgData) as Record<string, unknown>
      ...
      const svgData: SVGData = {
        width: parseSvgDimension((svgRoot as Record<string, unknown>)["@_width"]),
        height: parseSvgDimension((svgRoot as Record<string, unknown>)["@_height"]),
        elements: []
      }
...
export const excalidrawToSvgTool = createTool({
  ...
  execute: (args, context) => {
    ...
    try {
      ...
      voltlogger.error(`Excalidraw to SVG conversion failed: ${String(error)}`)
      throw new Error(`Failed to convert Excalidraw to SVG: ${String(error)}`)
    }
  },
})
