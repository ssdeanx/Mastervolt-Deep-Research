                    ...
                    <MessageContent>
                      ...
                      {message.parts?.map((part, idx) => {
                        ...
                        if (part.type === "text" && "text" in part) {
                          return (
                            <MessageResponse key={`text-${message.id}-${idx}`}>
                              {part.text}
                            </MessageResponse>
                          );
                        }
                        ...
                        if (isToolUIPart(part)) {
                          ...
                          return (
                            <Tool key={part.toolCallId} defaultOpen>
                              <ToolHeader title={toolName} type={part.type as `tool-${string}`} state={part.state} />
                              <ToolContent>
                                <>
      ...
      <div className="border-t bg-background p-4">
        <PromptInput onSubmit={handleSubmit} className="w-full">
          <PromptInputTextarea
            ...
            className="min-h-6 w-full resize-none bg-transparent text-sm placeholder:text-muted-foreground focus-visible:outline-none"
          />
          <PromptInputFooter>
            <div />
